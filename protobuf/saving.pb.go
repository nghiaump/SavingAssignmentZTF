...
type SavingAccount struct {
	...
	CreatedDate string `protobuf:"bytes,7,opt,name=created_date,proto3" json:"created_date,omitempty"`
	// @gotags: es:"due_date"
	DueDate string `protobuf:"bytes,8,opt,name=due_date,proto3" json:"due_date,omitempty"`
	// @gotags: es:"rate"
	Rate float32 `protobuf:"fixed32,9,opt,name=rate,proto3" json:"rate,omitempty"`
	// @gotags: es:"kyc"
	Kyc                  int32    `protobuf:"varint,10,opt,name=kyc,proto3" json:"kyc,omitempty"`
